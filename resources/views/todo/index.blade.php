                            ...
                            @forelse ($todos as $data)
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        @else
                                        <span class="bg-green-900 text-green-400 text-xs font-semibold px-2.5 py-0.5 rounded">                                                Done
                                            </span>
                                        @endif
                                    </td>
                                    <td class="px-6 py-4">
                                    <div class="flex space-x-3">
                                             ...
                                             <form action="{{ route('todo.destroy', $data) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="text-red-600 dark:text-red-400 hover:underline text-sm">                                                    Delete
                                                </button>
                                            </form>
                                        </div>
                                    </td>
